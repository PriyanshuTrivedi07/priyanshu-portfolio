...
const HomePage = () => {
  return (
    <>
      ...
      <Helmet>
        <title>Priyanshu Trivedi | Front-End Developer</title>
        <meta name="description" content="Welcome to my portfolio website. I'm Priyanshu Trivedi, a aspiring front-end developer specializing in React and modern web technologies. Explore my projects and skills here." />
        <meta name="keywords" content="portfolio, front-end developer, React, JavaScript, web development, Priyanshu Trivedi, priyanshutrivedi, priyanshutrivedi07" />
        
        <meta property="og:title" content="Priyanshu Trivedi | Portfolio" />
        <meta property="og:description" content="Welcome to my portfolio website. I'm Priyanshu Trivedi, a aspiring front-end developer specializing in React and modern web technologies. Explore my projects and skills here." />
        ...
        <link rel="canonical" href="https://priyanshutrivedi.vercel.app" />
      </Helmet>
